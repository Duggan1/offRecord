...
const deatilsUrl = 'https://www.ufc.com/event/ufc-fight-night-august-03-2024'
const Recurl = 'https://www.tapology.com/fightcenter/events/111167-ufc-fight-night'
const espnurl = 'https://www.espn.com/mma/fightcenter/_/id/600043635/league/ufc'
...
// Split the locationString by the line break and remove any leading/trailing whitespace
    ...
    $('.c-listing-fight__content').each((index, element) => {
      ...
      if (methodElement.length > 0) {
        ...
        if (methodText.includes('submission')) {
          method = 'Submission';
        } else if (methodText.includes('decision')) {
          method = 'Decision';
        } else if (methodText.includes('ko') || methodText.includes('tko')) {
          method = 'TKO/KO';
        } else if (methodText.includes('draw') || methodText.includes('no contest') || methodText.includes('dq')) {

...
function Home({user, ufcCard, stallUfcCard, locationCity,location}) {
    ...
    return (
        < div className="home" >
            ...
            <h1 className="homeheaders"
                ...
                : null }
                { isUfcCardLoaded ? <div  className='crdiv'   onClick={() => handleOptionClick('/section3')}><NavLink className='color-gold hgysnow' exact to="/section3">Off the Record Pick 'ems</NavLink>
                <h5 className='purple2   snow'style={{marginTop:'0%',paddingTop:'0%'}} >{mainEvent}</h5></div> : 
